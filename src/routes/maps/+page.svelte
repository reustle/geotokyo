...
<svelte:head>
	<title>Japanese Maps · {data.site.title}</title>
	<meta name="description" content={data.site.mapsIntro} />
</svelte:head>
...
<PageShell site={data.site} organizers={data.organizers} current="/maps">
	<div class="flex flex-col gap-[18px] border-b border-rule px-5 pt-14 pb-8 md:px-10">
		<div class="text-[11px] tracking-[.18em] text-accent">$ cat japanese-maps.md</div>
